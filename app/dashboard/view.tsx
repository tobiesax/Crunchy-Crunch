...
export default function Dashboard({ initial }: { initial: StoreData }) {
  ...
  return <main className="dashboard"><div className="dashTop"><div><p className="eyebrow">CRUNCHY BITES</p><h1>Commerce control room</h1><p>Orders, customers and WhatsApp automation in one place.</p></div><div className="dashActions"><a className="primary" href="/">VIEW STOREFRONT</a><form action="/api/auth/logout" method="post"><button className="logoutButton">LOG OUT</button></form></div></div>
